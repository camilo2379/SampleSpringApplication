        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
                <h1 class="mb-2">Registrar Garantia</h1>
            </div>
          </div>
        </div>
      </div>  
           ...
           <form action="garantiaRegistrar.htm" method="post"> 
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" name="numeroV" id="fullname" class="form-control" placeholder="Numero Garantia">
                </div>
              </div>
                  <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Tipo de garantia</label>
                  <select  name="garantia" id="fullname" class="form-control" >
