        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
                <h1 class="mb-2">Editar Garantia</h1>
            </div>
          </div>
        </div>
      </div>  
         ...
         <form action="garantiaEditarForm1.htm" method="post">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Numero de garantia</label>
                  <input type="text" name="numeroV" id="fullname" class="form-control" placeholder="Numero de Garantia">
                </div>
              </div>
          ...
          <div class="col-md-12 col-lg-8 mb-5">
           <form action="garantiaEditarForm2.htm" method="post">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Numero de garantia</label>
                  <input type="text" name="numeroV" id="fullname" class="form-control" value="${listaGarantias.get(0).getNumero()}" >
                </div>
              </div>
                  <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Tipo de garantia</label>
                     <input type="text" name="garantia" id="fullname" class="form-control" value="${listaGarantias.get(0).getTipo_garantia()}" >
                </div>
              </div>
                 
                <input type="hidden" name="id" value="${listaGarantias.get(0).getId()}">
              <div class="row form-group">
                <div class="col-md-12">
