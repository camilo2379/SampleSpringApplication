...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="slide-one-item home-slider owl-carousel">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/carro1.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
              
              <h1 class="mb-2">Con Tu Vehiculo</h1>
              <h2 class="caption">Viajas donde quieras</h2>
            </div>
          </div>
        </div>
      </div>  

      <div class="site-blocks-cover overlay" style="background-image: url(images/carro4.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
              <h1 class="mb-2">Nuestros Vehiculos y Repuestos</h1>
              <h2 class="caption">100% garantizados</h2>
            </div>
          </div>
        </div>
      </div> 
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/carro3.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
              <h1 class="mb-2">Nuestro Negocio</h1>
              <h2 class="caption">Ofrecer calidad de nuestros vehiculos</h2>
            </div>
          </div>
        </div>
      </div> 
    ...
    <div class="py-5 upcoming-events" style="background-image: url('images/fondo.jpg'); background-attachment: fixed;">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-md-6">
            <h2 class="text-white">Mira Nuestras Promociones</h2>
            <a href="#" class="text-white btn btn-outline-warning rounded-0 text-uppercase">Promociones</a>
          </div>
        </div>
    ...
    <div class="site-section block-14 bg-light">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 mx-auto text-center mb-5 section-heading">
            <h2>Comentarios sobre nosotros</h2>
          </div>
        </div>
          ...
          <div class="p-4">
            <div class="d-flex block-testimony">
              ...
              <div>
                ...
                <blockquote>&ldquo; que lindura es toda una belleza de automovil es el mejor del mundo entero les mando un gran abrazo para todos ustedes que Dios los bendiga!&rdquo;</blockquote>
              </div>
            </div>
          </div>
          <div class="p-4">
            <div class="d-flex block-testimony">
              ...
              <div>
                ...
                <blockquote>&ldquo; El carro que compre me ha salido muy bueno , nunca cambiare mi carro es unico !&rdquo;</blockquote>
              </div>
            </div>
          </div>
          <div class="p-4">
