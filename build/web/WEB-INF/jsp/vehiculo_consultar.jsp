        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
                <h1 class="mb-2">Consultar Vehiculo</h1>
            </div>
          </div>
        </div>
      </div>  
          ...
          <form action="vehiculoConsultarForm.htm" method="post"> 
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" name="matricula" id="fullname" class="form-control" placeholder="identificacion">
                </div>
              </div>
                  <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Nombre1</label>
                  <input type="text" name="nombreV" id="fullname" class="form-control" placeholder="Nombre1">
                </div>
              </div>
			...
			<div class="col-md-12">
				...
				<table class="table table-bordered table-striped">
					<thead>
					 ...
					 <c:forEach var="p" items="${listaVehiculos}">                                           
                                    <tr>
                                        ...
                                        <a href='vehiculoCrear.htm' class="btn btn-primary pill px-4 py-2">Crear Nuevo Vehiculo</a>
			</div>
		</div>
