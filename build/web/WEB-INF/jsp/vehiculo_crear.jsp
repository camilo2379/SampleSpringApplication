           ...
           <form action="vehiculoRegistrar.htm" method="post"> 
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Matricula Vehiculo</label>
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" name="color" id="fullname" class="form-control" placeholder="Color">
                </div>
              </div>
                     
                  <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Precio Vehiculo</label>
                ...
                <div class="row form-group">
                 <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <select  name="tipov" id="fullname" class="form-control" >
                      <option selected="selected">4X2</option>
