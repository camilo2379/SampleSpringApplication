...
<body>
	...
	<div class="about-heading">
		<h2>Crear <span>Vehiculo</span></h2>
	</div>
	<!-- //about-heading -->
			...
			<div class="signin-form profile">
				...
				<div class="login-form">
					<form action="vehiculoRegistrar.htm" method="post">
                                            ...
                                            <input type="text" name="nombreV" placeholder="Nombre Vehiculo" required>
                                            <input type="text" name="modelo" placeholder="Modelo de Vehiculo" required>
                                            <input type="text" name="color" placeholder="Color" required>
                                            <input type="text" name="precio" placeholder="Precio" required>
                                            <input type="text" name="disponible" placeholder="Disponible" required>
                                            <input type="text" name="tipov" placeholder="Tipo de Vehiculo 1. 4x2 o 2.4x4" required>      
                                            <input type="text" name="marca" placeholder="Marca de vehiculo 1.chevrolet o 2.renault" required>
