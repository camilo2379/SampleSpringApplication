								...
								<li ><a href="#" class="dropdown-toggle hvr-sweep-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Persona<span class="caret"></span></a>
									...
									<ul class="dropdown-menu">
										...
										<li><a class="hvr-sweep-to-bottom" href="vehiculoEditar.htm">Editar</a></li>
                                                                ...
                                                                <li class="active"><a href="#" class="dropdown-toggle hvr-sweep-to-bottom" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Venta<span class="caret"></span></a>
									<ul class="dropdown-menu">
		...
		<div class="container">
				...
				<div class="login-form">
					<form action="ventaEditarForm1.htm" method="post">
                                            <input type="text" name="numeroV" placeholder="numero de venta" required>
			...
			<div class="signin-form profile">
				...
				<div class="login-form">
					<form action="ventaEditarForm2.htm" method="post">
                                            <input type="text" name="numeroV" value="${listaVentas.get(0).getNumero()}" >
                                            <input type="text" name="preciot" value="${listaVentas.get(0).getPrecio_total()}" >
                                            <input type="text" name="cliente" value="${listaVentas.get(0).getId_persona()}" >
                                            <input type="text" name="vehiculo" value="${listaVentas.get(0).getId_vehiculo()}" >
                                            <input type="text" name="descripcion" value="${listaVentas.get(0).getDescripcion()}" >
                                            <input type="text" name="fecha" value="${listaVentas.get(0).getFecha()}" >
