          ...
          <div class="col-md-12 col-lg-8 mb-5">
           <form action="ventaEditarForm2.htm" method="post">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Numero de venta</label>
                  <input type="text" name="numeroV" id="fullname" class="form-control" value="${listaVentas.get(0).getNumero()}" >
                </div>
              </div>
                  <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Precio Total</label>
                     <input type="text" name="preciot" id="fullname" class="form-control" value="${listaVentas.get(0).getPrecio_total()}" >
                </div>
              </div>
                  <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Descripcion</label>
                  <input type="text" name="descripcion" id="fullname" class="form-control" value="${listaVentas.get(0).getDescripcion()}" >
                </div>
              </div>
                  <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Fecha</label>
                  <input type="date" name="fecha" id="fullname" class="form-control" value="${listaVentas.get(0).getFecha()}" >
                </div>
              </div>
                  <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Id Persona</label>
                  <input type="text" name="cliente" id="fullname" class="form-control" value="${listaVentas.get(0).getId_persona()}" >
                </div>
              </div>
                  <div class="row form-group">
                 <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Id Vehiculo</label>
                   <input type="text" name="vehiculo" id="fullname" class="form-control" value="${listaVentas.get(0).getId_vehiculo()}" >
                </div>
                </div> 
                 <div class="row form-group">
                 <div class="col-md-12 mb-3 mb-md-0">
