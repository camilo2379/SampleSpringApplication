...
<html lang="en">
  <head>
    <title>Catalogo Vehialpes</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="slide-one-item home-slider owl-carousel">
      ...
      <div class="site-blocks-cover overlay" style="background-image: url(images/fondocatalogo.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
              
              <h1 class="mb-2">Catalogo De Vehiculos</h1>
            </div>
          </div>
        </div>
      </div>  
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 mx-auto text-center mb-5 section-heading">
            <h2 class="mb-5">Nuestros Vehiculos</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              ...
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Carro1</a></h3>
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              ...
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Carro2</a></h3>
                <strong class="price">$ 300000/ Mas Barato Imposible</strong>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              ...
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Carro3</a></h3>
                <strong class="price">$ 300000/ Mas Barato Imposible</strong>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="images/img.jpg" alt="Image" class="img-fluid"></a>
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Carro4</a></h3>
                <strong class="price">$ 300000/ Mas Barato Imposible</strong>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="images/img1.jpg" alt="Image" class="img-fluid"></a>
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Carro5</a></h3>
                <strong class="price">$ 300000/ Mas Barato Imposible</strong>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-4 mb-5">
            ...
            <div class="hotel-room text-center">
              ...
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Carro7</a></h3>
                <strong class="price">$ 300000/ Mas Barato Imposible</strong>
              </div>
            </div>
          </div>
            ...
            <div class="hotel-room text-center">
              ...
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Carro8</a></h3>
                <strong class="price">$ 300000/ Mas Barato Imposible</strong>
              </div>
            </div>
          </div>
            ...
            <div class="hotel-room text-center">
              ...
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Carro9</a></h3>
                <strong class="price">$ 300000/ Mas Barato Imposible</strong>
              </div>
            </div>
          </div>
            <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="images/catalogo4.jpg" alt="Image" class="img-fluid"></a>
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Carro10</a></h3>
                <strong class="price">$ 300000/ Mas Barato Imposible</strong>
              </div>
            </div>
          </div>
            ...
            <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="images/catalogo6.jpg" alt="Image" class="img-fluid"></a>
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Carro12</a></h3>
                <strong class="price">$ 300000/ Mas Barato Imposible</strong>
              </div>
            </div>
          </div>
            <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="images/catalogo7.jpeg" alt="Image" class="img-fluid"></a>
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Carro13</a></h3>
                <strong class="price">$ 300000/ Mas Barato Imposible</strong>
              </div>
            </div>
          </div>
            ...
            <div class="hotel-room text-center">
              ...
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Carro14</a></h3>
                <strong class="price">$ 300000/ Mas Barato Imposible</strong>
              </div>
            </div>
          </div>
            <div class="col-md-6 col-lg-4 mb-5">
            <div class="hotel-room text-center">
              <a href="#" class="d-block mb-0 thumbnail"><img src="images/catalogo9.jpg" alt="Image" class="img-fluid"></a>
              <div class="hotel-room-body">
                <h3 class="heading mb-0"><a href="#">Carro15</a></h3>
                <strong class="price">$ 300000/ Mas Barato Imposible</strong>
              </div>
            </div>
          </div>
