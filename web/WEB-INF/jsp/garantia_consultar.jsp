...
<html lang="en">
  <head>
    <title>Consultar Garantia</title>
    <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
                <h1 class="mb-2">Consultar Garantia</h1>
            </div>
          </div>
        </div>
      </div>  
		...
		<div class="row-fluid">
			<div class="col-md-12">
				...
				<table class="table table-bordered table-striped">
					<thead>
						<tr>
							<th>Numero De Garantia</th>
							<th>Tipo de Garantia</th>
							
						</tr>
					</thead>
					</tbody>
					 <c:forEach var="p" items="${listaGarantias}">                                           
                                    <tr>
                                        <td>${p.getNumero()}</td>
                                        ...
                                        <a href='garantiaCrear.htm' class="btn btn-primary pill px-4 py-2">Crear Nuevo Garantia</a>
			</div>
		</div>   
          </div>
        </div>
