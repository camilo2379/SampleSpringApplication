...
<html lang="en">
<head>
<title>Vehiculo Consultar</title>
			...
			<div class="signin-form profile">
				...
				<div class="login-form">
					<form action="vehiculoConsultarForm.htm" method="post">
                                            <input type="text" name="matricula" placeholder="Numero Matricula" required>
                            ...
                            <table id="tablaResultado" class="table table-striped table-hover table-bordered" >
                                <thead>       
                                    <tr>
                                       ...
                                       <th>Precio</th>
                                       <th>Disponible</th>
                                       <th>Id De Tipo Vehiculo</th>
                                       <th>Id De Tipo Marca</th>
