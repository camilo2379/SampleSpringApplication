        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
                <h1 class="mb-2">Editar Vehiculo</h1>
            </div>
          </div>
        </div>
      </div>  
         ...
         <form action="vehiculoEditarForm1.htm" method="post">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" name="nombreV" id="fullname" class="form-control" placeholder="Nombre Vehiculo">
                </div>
              </div>
          ...
          <div class="col-md-12 col-lg-8 mb-5">
           <form action="vehiculoEditarForm2.htm" method="post">
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Matricula</label>
                  <input type="text" name="matricula" id="fullname" class="form-control" value="${listaVehiculos.get(0).getMatricula()}" >
                </div>
              </div>
                  <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Nombre Vehiculo</label>
                     <input type="text" name="nombreV" id="fullname" class="form-control" value="${listaVehiculos.get(0).getNombre_v()}" >
                </div>
              </div>
                  <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Modelo</label>
                  <input type="text" name="modelo" id="fullname" class="form-control" value="${listaVehiculos.get(0).getModelo()}" >
                </div>
              </div>
                  <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Color</label>
                  <input type="text" name="color" id="fullname" class="form-control" value="${listaVehiculos.get(0).getColor()}" >
                </div>
              </div>
                  <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Precio</label>
                  <input type="text" name="precio" id="fullname" class="form-control" value="${listaVehiculos.get(0).getPrecio()}" >
                </div>
              </div>
                  <div class="row form-group">
                 <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Tipo Vehiculo</label>
                   <input type="text" name="tipov" id="fullname" class="form-control" value="${listaVehiculos.get(0).getTipo_vehiculo()}" >
                </div>
                </div>      
