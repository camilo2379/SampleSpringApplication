                      ...
                      <li class="has-children">
                        ...
                        <ul class="dropdown arrow-top">
                          <li class="has-children">
                            <a >Cliente</a>
                            <ul class="dropdown">
                              <li class="active"><a href="personaCrear.htm">Registrar</a></li>
           ...
           <form action="ventaRegistrar.htm" method="post"> 
              ...
              <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" name="numeroV" id="fullname" class="form-control" placeholder="Numero Venta">
                </div>
              </div>
                  <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                ...
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <input type="text" name="descripcion" id="fullname" class="form-control" placeholder="Descripcion">
                </div>
              </div>
                  <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  ...
                  <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Cliente Id</label>
                  <input type="text" name="cliente" id="fullname" class="form-control" placeholder="Cliente">
                </div>
              </div>
                   <div class="row form-group">
                <div class="col-md-12 mb-3 mb-md-0">
                  <label class="font-weight-bold" for="name">Vehiculo Id</label>
                  <input type="text" name="vehiculo" id="fullname" class="form-control" placeholder="vehiculo Id">
                </div>
              </div>
                <div class="row form-group">
                 <div class="col-md-12 mb-3 mb-md-0">
