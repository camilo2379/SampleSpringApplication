			...
			<div class="signin-form profile">
				...
				<div class="login-form">
					<form action="ventaRegistrar.htm" method="post">
                                            ...
                                            <input type="text" name="preciot" placeholder="Precio Total" required>
                                            <input type="text" name="cliente" placeholder="Tipo Cliente" required>
                                            <input type="text" name="vehiculo" placeholder="Tipo Vehiculo" required>
                                            <input type="text" name="descripcion" placeholder="Descripcion" required>
                                            <input type="date" name="fecha" placeholder="Fecha de venta" required="">     
